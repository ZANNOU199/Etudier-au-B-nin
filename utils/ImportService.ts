...
// Updated processAcademicCSV to support asynchronous callbacks for API interaction
export const processAcademicCSV = async (
  file: File,
  currentUniversities: University[],
  addUniversity: (u: University) => Promise<any>,
  updateUniversity: (u: University) => Promise<any>,
  addMajor: (m: Major) => Promise<any>
